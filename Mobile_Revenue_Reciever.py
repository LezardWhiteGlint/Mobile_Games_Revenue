...
def data_extractor(m,d,wait_time):
    ...
    for days in range(d):
        ...
        for i in range(5):
            ...
            revenue.append(driver.find_element_by_xpath('//*[@id="__t_grid_1"]/tbody/tr['+str(i+2)+']/td[3]').text)
...
game_name,revenue = data_extractor(6,15,1)
data_writer(80,755)
